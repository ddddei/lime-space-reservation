...
export const initialSpaces: readonly Space[] = [
  ...
  },
  {
    ...
    category: "lifestyle",
    capacity: 8,
    description: "08:00-22:00 이용 가능한 8명 규모 모임공간입니다. 빔프로젝터, HDMI, 스피커, 와이파이, 콘센트, 냉난방을 사용할 수 있습니다. 음료, 다과, 냄새 안 나는 음식 반입이 가능하며 정수기, 커피머신, 다과를 이용할 수 있습니다.",
    imageUrl: "https://images.unsplash.com/photo-1497366412874-3415097a27e7?auto=format&fit=crop&w=900&q=80",
    features: ["08:00-22:00", "8명", "빔프로젝터", "HDMI", "스피커", "와이파이", "콘센트", "냉난방", "음료·다과 가능", "냄새 안 나는 음식 가능", "정수기", "커피머신", "다과 이용 가능"],
    operatingHours: chitChatHours,
    isActive: true,
    isPublicVisible: true,
    adminMemo: "Excel 원본: 광명시 안재로6번길 31-1 101호. 음식물 쓰레기 발생 없이 이용 후 원상복구 필수.",
    sortOrder: 5,
  },
  {
    id: "tea-party",
    ...
    category: "lifestyle",
    capacity: 16,
    description: "월요일은 정기휴무, 수요일과 일요일은 10:00-19:00, 화·목·금·토요일은 10:00-21:00 운영합니다. 12-16명 이용 가능하며 TV, HDMI, 블루투스 스피커, 콘센트, 냉난방을 사용할 수 있습니다. 외부 음식 반입은 불가합니다.",
    imageUrl: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=900&q=80",
    features: ["월요일 휴무", "수·일 10:00-19:00", "화·목·금·토 10:00-21:00", "12-16명", "TV", "HDMI", "블루투스 스피커", "콘센트", "냉난방", "외부 음식 불가"],
    operatingHours: teaPartyHours,
    isActive: true,
    isPublicVisible: true,
    adminMemo: "Excel 원본: 광명시 구름산로48번길 18 2층. 2층 단체 대관 시 1층에 인원수에 맞게 테이블과 의자 배치 예정. 1층 와이파이 수신이 미흡할 수 있음.",
    sortOrder: 6,
  },
];
